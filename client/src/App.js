...
import { BrowserRouter as Router, Routes, Route, Outlet, Navigate, useNavigate, NavLink } from 'react-router-dom';
        ...
        <div className="d-flex user-layout-wrapper">
            ...
            <div className="d-flex flex-column flex-grow-1 user-content-and-footer-wrapper">
                ...
                <header className="mobile-topbar">
                    ...
                    <NavLink to="/" className="mobile-topbar-brand text-decoration-none">
                        <span className="brand-accent">Music</span>Vibes
                    </NavLink>
                </header>

                <main className="main-content-area player-padding-bottom">
                    <Outlet />
                </main>
                <Footer />
            </div>
    ...
    return (
        <div className="flex-grow-1 d-flex flex-column admin-main-layout-content">
            <header className="admin-header bg-dark text-white p-3 d-flex justify-content-between align-items-center">
                <h4 className="mb-0 ms-5 ms-lg-0">Admin Panel</h4>
